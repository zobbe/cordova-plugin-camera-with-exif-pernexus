...
## cordova-plugin-camera-with-exif-pernexus

!! This is a copy of remoorejr's cordova-plugin-camera-with-exif https://github.com/remoorejr/cordova-plugin-camera-with-exif to work with Cordova iOS 4.1
